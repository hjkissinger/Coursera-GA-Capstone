...
```
This article contains the R Script for the Google Analytics Capstone: Cyclistic Bikes. If you are interested in learning more about the derived insights click [here](link here)!
